...
// Formerly the root "/" page (internally named MissionControlPage before that
// name meant something else — see app/mission-control/page.tsx, which is now
// the actual default view). Preserved here, unlinked from nav for now, so
