...
- **Vocabulary is fixed.** Domain, Project, Mission, Outcome, Milestone, Action,
  Artifact, Decision, Log. Read [`docs/arcadia-semantics.md`](docs/arcadia-semantics.md)
...
- **Schema changes need a migration**, not just an edit to `database/schema.sql`.
  See [`docs/AGENT_ORIENTATION.md`](docs/AGENT_ORIENTATION.md) — it is the
...
| [`docs/COMMANDS.md`](docs/COMMANDS.md) | The full command guide |
| [`docs/AGENT_ORIENTATION.md`](docs/AGENT_ORIENTATION.md) | Architecture that trips up cold starts |
| [`docs/arcadia-semantics.md`](docs/arcadia-semantics.md) | Canonical vocabulary |
