...
actions:
  ...
  - id: build-operator-attention-board
    ...
    acceptance_criteria:
      ...
      - Workspace `reviewFocus` can bound the focused set, order priority Projects, and park Projects without mutating or deleting their Decisions, packets, Runs, or evidence.
