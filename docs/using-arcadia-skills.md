...
- `arcadia-agent-ask`: draft, edit, and preview isolated
  `.arcadia/asks/agent-ask-<request_id>.yaml` inputs without an approval
  pause; Codex and Claude Code share it through
  `~/.claude/skills/arcadia-agent-ask ->
